...
var connection = mysql.createConnection({
  host     : 'aishwarya-mysql.c72b0uwdjqt4.us-east-1.rds.amazonaws.com',
  port     : '3306',
  user     : 'aish_master',
  password : 'Aishkavin2',
...
lineReader.eachLine('./Project4Data/ProductRecords.json', function(line, last) {
  execute = false;
...
//****************************************************Change the query to align with your schema******************************************************/
    if (numRecords == recordBlock) {
      query = `INSERT INTO products_read (productName, groups, productDescription, asin) VALUES ${values};`; //Template, replaces ${values} with the value of values.
      values = "";
      numRecords = 0;
      execute = true;
      //console.log(query);
